...
public class Main_length{
    ...
    private static void prepara_cenarios(Dados_password[] entrada, String type) throws IOException {
        ...
        //Para insertionSort
        // Ordena melhor caso
        algoritmos_ordencao.algoritmo_ordena(melhorCaso);
    ...
    private static void ordenar(Dados_password[] entrada, String type, String metodo_ordencao, String cenario) throws IOException {
        ...
        switch (metodo_ordencao) {
            case "insertionSort":
                ...
                algoritmos_ordencao.insertionSort(entrada);
            ...
            case "bubbleSort":
                ...
                algoritmos_ordencao.bubbleSort(entrada);
            ...
            case "selectionSort":
                ...
                algoritmos_ordencao.selectionSort(entrada);
            ...
            algoritmos_ordencao.quickSort(entrada);
            ...
            algoritmos_ordencao.quickSortMedianaDeTres(entrada);
            ...
            case "heapSort":
                ...
                algoritmos_ordencao.heapSort(entrada);
            ...
            case "mergeSort":
                ...
                algoritmos_ordencao.mergeSort(entrada);
            ...
            algoritmos_ordencao.countingSort(entrada);
