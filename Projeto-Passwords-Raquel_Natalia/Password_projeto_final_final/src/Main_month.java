...
public class Main_month {
    ...
    private static void prepara_cenarios(Dados_password[] entrada, String type) throws IOException {
        ...
        //Para insertionSort
        // Ordena melhor caso
        algoritmos_ordencao_month.algoritmo_ordena(melhorCaso);
    ...
    private static void ordenar(Dados_password[] entrada, String type, String metodo_ordencao, String cenario) throws IOException {
        ...
        switch (metodo_ordencao) {
            case "insertionSort":
                ...
                algoritmos_ordencao_month.insertionSort(entrada);
            ...
            case "bubbleSort":
                ...
                algoritmos_ordencao_month.bubbleSort(entrada);
            ...
            case "selectionSort":
                ...
                algoritmos_ordencao_month.selectionSort(entrada);
            ...
            algoritmos_ordencao_month.quickSort(entrada);
            ...
            algoritmos_ordencao_month.quickSortMedianaDeTres(entrada);
            ...
            case "heapSort":
                ...
                algoritmos_ordencao_month.heapSort(entrada);
            ...
            case "mergeSort":
                ...
                algoritmos_ordencao_month.mergeSort(entrada);
            ...
            algoritmos_ordencao_month.countingSort(entrada);
